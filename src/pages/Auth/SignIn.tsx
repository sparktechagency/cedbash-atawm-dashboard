...
const SignIn = () => {
  ...
  return (
    <div className="text-base-color min-h-screen flex items-center justify-center">
      <Container>
        <div className="w-full sm:w-[80%] lg:w-[60%] xl:w-[50%] mx-auto flex flex-col items-center justify-items-center gap-5">
          <img
            src={AllImages.logo}
            alt="logo"
            className="w-auto object-cover hidden lg:block"
          />
